...
import { Box, Button, Divider, AbsoluteCenter, Flex, Text } from '@chakra-ui/react'
...
export const DocumentSection: React.FC<DocumentSectionProps> = ({
  ...
  return (
    <>
      ...
      {isNewFamily && (
        <Text>Please create the family first before attempting to add documents</Text>
      )}
      ...
      {!isNewFamily && (
        <Box>
          <Button
            ...
            rightIcon={
              familyDocuments.length === 0 ? (
                <WarningIcon color="red.500" data-test-id="warning-icon-document" />
              ) : undefined
            }
          >
            Add new Document
